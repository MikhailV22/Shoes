...
@Named("medicaltypeConverter")
@RequestScoped
public final class MedicaltypeConverter implements Converter {

    @EJB
    private MedicaltypeFacade service;
...
//    	System.out.println("value."+value);
        try {
            ...
            Medicaltype entity = service.find(parsedValue);
            if (entity == null) {
...
//    	System.out.println("getAsString."+value.getClass().getName());
        ...
        return value instanceof Medicaltype ? ((Medicaltype) value).getId().toString() : "0";
    }
}